...
const sftr = require("./sendTenTrendingResults");
const {parser} = require("html-metadata-parser");

function sendFiveBrowseResults(countryCode, userPhoneNumber, productCategory, currentBrowseProductsIndex, currentMessageTimeStamp, fs, client) {
  return new Promise((resolve, reject) => {
    ...
    if (productCategory == "0") {
      sftr.sendFiveTrendingResults(countryCode, userPhoneNumber, productCategory, currentBrowseProductsIndex, fs);
      return;
    } else {
...
exports.sendFiveBrowseResults = sendFiveBrowseResults;
